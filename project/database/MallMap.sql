-- MySQL Script generated by MySQL Workbench / Edited by Gemini
-- Model: MallMAP Version: 1.1
...
CREATE TABLE IF NOT EXISTS `MallMAP`.`Store` (
  ...
  INDEX `fk_Store_mall1_idx` (`MallID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `MallMAP`.`FavoriteStore` (
  ...
  UNIQUE INDEX `User_Store_UNIQUE` (`UserID` ASC, `StoreID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `MallMAP`.`FavoriteProduct` (
  ...
  UNIQUE INDEX `User_Product_UNIQUE` (`UserID` ASC, `ProductID` ASC) VISIBLE,
